<template>
  <!-- 渲染模式 -->
  <div v-if="!isPreview" class="image-top-template">
    <!-- 上半部分图片 -->
    <div 
      v-if="hasCustomImage" 
...
const imageRatio = computed(() => {
  ...
  return props.customStyle?.imageRatio || 0.5;
});
